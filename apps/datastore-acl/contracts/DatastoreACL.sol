...
contract DatastoreACL is AragonApp, ACLHelpers {
     ...
     */
    function createObjectPermission(address _entity, uint256 _obj, bytes32 _role, address _permissionManager) external {
     ...
     */
    function grantObjectPermission(address _entity, uint256 _obj, bytes32 _role, address _sender) external {
     ...
     */
    function revokeObjectPermission(address _entity, uint256 _obj, bytes32 _role, address _sender) external {
